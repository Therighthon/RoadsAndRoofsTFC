...
public class GravelPathSlabBlock extends Block implements SimpleWaterloggedBlock
{
    ...
    public GravelPathSlabBlock(Properties pProperties)
    {
        super(pProperties.speedFactor(GravelPathBlock.getDefaultSpeedFactor()));
