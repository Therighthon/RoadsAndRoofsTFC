...
public class StonePathSlabBlock extends Block implements SimpleWaterloggedBlock
{
    ...
    public StonePathSlabBlock(Properties pProperties)
    {
        super(pProperties.speedFactor(StonePathBlock.getDefaultSpeedFactor()));
