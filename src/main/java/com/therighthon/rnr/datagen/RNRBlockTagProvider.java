...
//        tag(ModRegistry.SLIGHTLY_SLOW_BLOCKS_BLOCK_TAG);
        ...
        tag(RNRTags.Blocks.CONCRETE_SPREADABLE).add(RNRBlocks.BASE_COURSE.get());
        ...
        tag(RNRTags.Blocks.ALL_WORKING_CONCRETE_ROADS).addTags(RNRTags.Blocks.WORKING_CONCRETE_ROAD_BLOCKS, RNRTags.Blocks.WORKING_CONCRETE_ROAD_SLABS, RNRTags.Blocks.WORKING_CONCRETE_ROAD_STAIRS);
        ...
        tag(RNRTags.Blocks.CRACKING_WET_CONCRETE_ROADS).add(RNRBlocks.WET_CONCRETE_ROAD.get());
